...
The `.liquid-glass-strong` CSS class SHALL apply the same structure as `.liquid-glass` but with `backdrop-filter: blur(50px)`, `box-shadow: 4px 4px 4px rgba(0,0,0,0.05), inset 0 1px 1px rgba(255,255,255,0.15)`, and higher gradient opacities (0.5/0.2).

#### Scenario: Strong glass effect renders
- **WHEN** an element has `.liquid-glass-strong` class
- **THEN** it displays a more prominent frosted glass effect with stronger blur and border visibility
