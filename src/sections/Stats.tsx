...
export function Stats() {
  ...
  const stats = [
    ...
    {
      value: t("stats.stat2.value", "15+"),
      label: t("stats.stat2.label", "Projects delivered"),
    },
    {
    ...
    <section id="stats" className="relative py-24 px-6 md:px-16 lg:px-24">
      <div className="relative z-10 liquid-glass-strong rounded-3xl p-12 md:p-16 max-w-5xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 text-center">
          {stats.map((stat, i) => (
            <div key={i} className={i === stats.length - 1 && stats.length % 2 !== 0 ? "col-span-2 lg:col-span-1" : ""}>
