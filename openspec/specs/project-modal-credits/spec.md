...
The project modal's credits — developer attribution and project links (GitHub / Live) — combined into one unit beside the main image (desktop) or as uniform tabs below it (mobile), replacing the former developer pills and bottom preview-image link cards.
